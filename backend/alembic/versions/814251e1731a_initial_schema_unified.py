...
def upgrade() -> None:
    ...
    sa.Column('subscription_tier', postgresql.ENUM('LITE', 'STANDARD', 'PREMIUM', name='subscriptiontier', create_type=False), nullable=False),
    ...
    sa.Column('phone', sa.String(length=50), nullable=True),
    sa.Column('role', postgresql.ENUM('SUPER_ADMIN', 'AGENCY_ADMIN', 'RECRUITER', 'VIEWER', name='userrole', create_type=False), nullable=False),
    sa.Column('is_active', sa.Boolean(), nullable=False),
    ...
    sa.Column('status', postgresql.ENUM('ACTIVE', 'PASSIVE', 'PLACED', 'NOT_INTERESTED', 'BLACKLISTED', name='candidatestatus', create_type=False), nullable=False),
    sa.Column('source', postgresql.ENUM('DIRECT_APPLICATION', 'REFERRAL', 'LINKEDIN', 'PNET', 'CAREER_JUNCTION', 'HEADHUNTED', 'WALK_IN', 'OTHER', name='candidatesource', create_type=False), nullable=True),
    ...
    sa.Column('experience_level', postgresql.ENUM('ENTRY_LEVEL', 'MID_LEVEL', 'SENIOR_LEVEL', 'EXECUTIVE', name='experiencelevel', create_type=False), nullable=True),
    sa.Column('education_level', sa.String(length=100), nullable=True),
    sa.Column('certifications', sa.ARRAY(sa.String()), nullable=True),
    ...
    sa.Column('employment_type', postgresql.ENUM('FULL_TIME', 'PART_TIME', 'CONTRACT', 'TEMPORARY', 'INTERNSHIP', 'FREELANCE', name='employmenttype', create_type=False), nullable=False),
    ...
    sa.Column('status', postgresql.ENUM('DRAFT', 'ACTIVE', 'PAUSED', 'CLOSED', 'FILLED', 'EXPIRED', name='jobstatus', create_type=False), nullable=False),
    ...
    sa.Column('status', postgresql.ENUM('APPLIED', 'SCREENING', 'SHORTLISTED', 'INTERVIEW_SCHEDULED', 'INTERVIEWED', 'OFFER_PENDING', 'OFFER_MADE', 'OFFER_ACCEPTED', 'HIRED', 'REJECTED', 'WITHDRAWN', name='applicationstatus', create_type=False), nullable=False),
    sa.Column('source', postgresql.ENUM('DIRECT_APPLY', 'RECRUITER_ADDED', 'REFERRAL', 'HEADHUNTED', 'IMPORTED', name='applicationsource', create_type=False), nullable=True),
    ...
    sa.Column('rejection_reason', postgresql.ENUM('QUALIFICATIONS', 'EXPERIENCE', 'SALARY', 'LOCATION', 'CULTURE_FIT', 'BETTER_CANDIDATE', 'POSITION_FILLED', 'OTHER', name='rejectionreason', create_type=False), nullable=True),
